...
$recycleBinDir = 'movuploads/cihm-recycle/'; // Changed to cihm-recycle
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['action'] === 'restore_image') {
        ...
        if (is_dir($itemPath)) {
            // Restoring a folder
            $restoreFolderPath = 'movuploads/cihm-mov/' . $itemName; // Change to cihm-mov
            ...
            if (!is_dir($restoreFolderPath)) {
                ...
                if (rename($itemPath, $restoreFolderPath)) {
                    ...
                    $sql = "INSERT INTO cihm_mov (folder_name) VALUES ('$itemName')";
            ...
            $originalFolder = 'movuploads/cihm-mov/' . $folderName; // Change to cihm-mov
