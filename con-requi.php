    ...
    <body>
        ...
        <div class="content-requi">
                <div class="button-container">
                    <button onclick="window.location.href='con-add-requi.php'">Requisition Form</button>
                </div>
                    ...
                    <div class="table-container">
                        <table class="crud-table">
                            ...
                            <tbody>
                                ...
                                $countSql = "SELECT COUNT(*) as total FROM con_requisition";
                                $countResult = $conn->query($countSql);
                                $totalRecords = $countResult->fetch_assoc()['total'];
                                $totalPages = ceil($totalRecords / $limit); // Calculate total pages

                                // Fetch paginated requisition details
                                $requisitionSql = "SELECT * FROM con_requisition ORDER BY requisition_id LIMIT $limit OFFSET $offset";
                                ...
                                if ($resultRequisitions && $resultRequisitions->num_rows > 0) {
                                    while ($row = $resultRequisitions->fetch_assoc()) {
                                        echo "<tr>
                                            ...
                                            <td class='edit'>
                                                <a href='con-edit-requisition.php?requisition_id=" . $row["requisition_id"] . "'>EDIT</a>
                    ...
                    <div class="table-container">
                        <table class="crud-table">
                            ...
                            <tbody>
                                ...
                                $itemsSql = "SELECT * FROM con_items ORDER BY requisition_id LIMIT $limit OFFSET $offset"; // Removed LIMIT and OFFSET for items
        ...
        <script>
            ...
            deleteButtons.forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    fetch(`con-requi-delete.php?requisition_id=${requisitionId}`)
                ...
                function deleteRequisition(requisitionId, itemName) {
                    fetch(`con-requi-delete.php?requisition_id=${requisitionId}&item_name=${itemName}`, {
                        method: 'POST'
                    })
                    .then(response => response.json())
                    .then(data => {
