...
$recycleBinDir = 'movuploads/con-recycle/'; // Changed to con-recycle
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['action'] === 'restore_image') {
        ...
        if (is_dir($itemPath)) {
            // Restoring a folder
            $restoreFolderPath = 'movuploads/con-mov/' . $itemName; // Change to con-mov
            ...
            if (!is_dir($restoreFolderPath)) {
                ...
                if (rename($itemPath, $restoreFolderPath)) {
                    ...
                    $sql = "INSERT INTO con_mov (folder_name) VALUES ('$itemName')";
            ...
            $originalFolder = 'movuploads/con-mov/' . $folderName; // Change to con-mov
