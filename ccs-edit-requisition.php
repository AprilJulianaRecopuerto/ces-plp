...
if (isset($_GET['requisition_id'])) {
    ...
    $sql = "SELECT * FROM ccs_requisition WHERE requisition_id = $requisitionId";
    ...
    $itemsSql = "SELECT * FROM ccs_items WHERE requisition_id = $requisitionId";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_GET['requisition_id'])) {
        ...
        $updateRequisitionSql = "UPDATE ccs_requisition SET 
            date='$date',
            name='$name',
            position='$position',
        ...
        if ($conn->query($updateRequisitionSql) === TRUE) {
            ...
            $deleteItemsSql = "DELETE FROM ccs_items WHERE requisition_id = $requisitionId";
            ...
            foreach ($items as $index => $itemName) {
                if (!empty($itemName)) { // Ensure the item name is not empty
                    ...
                    $insertItemsSql = "INSERT INTO ccs_items (requisition_id, item_name, total_items, total_usage) 
