...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        // Fetch the link from evaluation_links where department = 'ccs'
        $linkQuery = "SELECT response_link FROM evaluation_links WHERE department = 'CCS'";
...
// Fetch project titles from the ccs table
$sql = "SELECT proj_title FROM ccs";
