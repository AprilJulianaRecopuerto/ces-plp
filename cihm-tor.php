                ...
                <div class="table-container">
                    <table class="crud-table">
                        ...
                        <tbody>
                            ...
                            // Count total records
                            $countSql = "SELECT COUNT(*) as total FROM cihm_tor";
                            $countResult = $conn->query($countSql);
                            $totalRecords = $countResult->fetch_assoc()['total'];
                            $totalPages = ceil($totalRecords / $limit); // Calculate total pages

                            // Fetch paginated event form details
                            $eventFormSql = "SELECT * FROM cihm_tor ORDER BY id LIMIT $limit OFFSET $offset";
                ...
                <div class="table-container">
                    <table class="crud-table">
                        ...
                        <tbody>
                            <?php
                            // Fetch event details
                            $eventDetailsSql = "SELECT * FROM cihm_food ORDER BY cihm_tor_id, event_date"; // Ensure the table name is correct
                            ...
                            if ($resultEventDetails && $resultEventDetails->num_rows > 0) {
                                ...
                                while ($row = $resultEventDetails->fetch_assoc()) {
                                    $eventData[$row['cihm_tor_id']][$row['event_date']][] = $row;
                                }
