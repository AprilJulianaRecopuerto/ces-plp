...
<head>
    ...
    <body>
        ...
        <div class= "buttons">
            <a href="admin-edit-profile.php" class="edit-profile-button">Change Profile Picture</a>
            <a href="admin-change-password.php" class="change-password-button">Change Password</a>
        </div>
