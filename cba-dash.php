...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_notification'])) {
    ...
    $sql = "DELETE FROM cba_notifications WHERE id = ?";
    ...
    <body>
        ...
        <div class="content">
                    ...
                    <a href="cba-projlist.php">
                        ...
                        <div class="activities-details">
                            <div class="total-activities-count">
                                ...
                                $sql = "SELECT COUNT(*) as total FROM cba";
                                $result = $conn->query($sql);
            ...
            <div class="container">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['task_id'])) {
                    ...
                    $stmt = $conn->prepare("SELECT task_description FROM cba_tasks WHERE id = ?");
                    ...
                    $stmt = $conn->prepare("UPDATE cba_tasks SET status = 'done' WHERE id = ?");
                    $stmt->bind_param("i", $task_id);
                ...
                $sql = "SELECT id, task_description, due_date FROM cba_tasks WHERE status = 'pending' ORDER BY created_at DESC";
                $result = $conn->query($sql);
                ...
                $sql_done = "SELECT id, task_description, due_date FROM cba_tasks WHERE status = 'done' ORDER BY created_at DESC";
            ...
            <?php
                ...
                $url = "https://ces-python-1da82b6d81f5.herokuapp.com/get_recommended_events/College%20of%20Business%20Administration";
        ...
        <script>
            ...
            function markNotificationsAsRead() {
                fetch('cba-mark-notifications-read.php', {
                    method: 'POST',
                })
           ...
           // Function to delete a notification
            function deleteNotification(notificationId) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch('cba-delete-notification.php', {
                            method: 'POST',
                            headers: {
            ...
            document.addEventListener("DOMContentLoaded", () => {
                ...
                function fetchNotifications() {
                    ...
                    fetch(`cba-fetch_task.php?last_fetch_time=${encodeURIComponent(lastFetchTime)}`)
                        .then(response => response.json())
                        .then(data => {
                            const notificationCountElement = document.querySelector('.notification-count');
                            ...
                            if (data.notifications.length > 0) {
                                ...
                                notificationCountElement.textContent = data.notifications.filter(n => n.cba_status === 'unread').length;
                            } else {
