...
<head>
    ...
    <body>
        ...
        <div class= "buttons">
            <a href="ccs-edit-profile.php" class="edit-profile-button">Change Profile Picture</a>
            <a href="ccs-change-password.php" class="change-password-button">Change Password</a>
        </div>
