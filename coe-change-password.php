...
if ($result->num_rows > 0) {
    ...
    header("Location: coe-change-password.php");
    exit;
}
    ...
    <body>
        ...
        <div class="content-editor">
            <div class="form-container">
                ...
                <form action="coe-change-password.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <ul id="passwordCriteria">
                            ...
                            <li id="uppercaseCriteria" class="criteria">At least 1 uppercoee letter</li>
