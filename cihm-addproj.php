...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO cihm (date_of_sub, semester, lead_person, dept, implementor, proj_title, classification, specific_activity, dateof_imple, time_from, time_to, district, barangay, beneficiary, duration, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

    if ($stmt === false) {
        $_SESSION['error'] = "Prepare statement failed: " . $conn->error;
        $redirect_url = 'cihm-addproj.php';
    } else {
        // Bind parameters
        ...
        if ($stmt->execute()) {
            ...
            $redirect_url = 'cihm-projlist.php'; // Redirect URL
        } else {
            $_SESSION['error'] = "Error: " . $stmt->error; // Set session variable for error
            $redirect_url = 'cihm-addproj.php'; // Redirect URL
        }
            ...
            <div class="form-container">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="dept" name="dept" value="College of International Hospitality Management" readonly>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function showSuccessAlert() {
                Swal.fire({
                    ...
                    window.location.href = "cihm-projlist.php"; // Redirect to the dashboard or desired page
                });
            }
