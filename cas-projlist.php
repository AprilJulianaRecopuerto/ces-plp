...
if (isset($_POST['delete_id'])) {
    ...
    $sql_fetch = "SELECT proj_title FROM cas WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        if ($result->num_rows > 0) {
            ...
            try {
                ...
                header("Location: cas-projlist.php");
                exit;
            }
        } else {
    ...
    $stmt->close();
    header("Location: cas-projlist.php"); // Redirect back to project list page
    exit();
}
    ...
    <body>
        ...
        <div class="content-projectlist">
            <div class="button-container">
                <button onclick="logAndRedirect('Add Project', 'cas-addproj.php')">Add Project</button>
            </div>
