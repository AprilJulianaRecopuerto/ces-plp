...
<head>
    ...
    <body>
        ...
        <div class= "buttons">
            <a href="cba-edit-profile.php" class="edit-profile-button">Change Profile Picture</a>
            <a href="cba-change-password.php" class="change-password-button">Change Password</a>
        </div>
