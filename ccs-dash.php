...
$query = "SELECT COUNT(*) as count FROM ccs_notifications WHERE ccs_status = 'unread'";
...
$sql = "SELECT id, task_description, created_at, ccs_status FROM ccs_notifications ORDER BY created_at DESC";
    ...
    <body>
        ...
        <div class="content">
                    ...
                    <a href="ccs-projlist.php">
                        ...
                        <div class="activities-details">
                            <div class="total-activities-count">
                                ...
                                $sql = "SELECT COUNT(*) as total FROM ccs";
                                $result = $conn->query($sql);
            ...
            <div class="container">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['task_id'])) {
                    ...
                    $stmt = $conn->prepare("SELECT task_description FROM ccs_tasks WHERE id = ?");
                    ...
                    $stmt = $conn->prepare("UPDATE ccs_tasks SET status = 'done' WHERE id = ?");
                    $stmt->bind_param("i", $task_id);
                ...
                $sql = "SELECT id, task_description, due_date FROM ccs_tasks WHERE status = 'pending' ORDER BY created_at DESC";
                $result = $conn->query($sql);
                ...
                $sql_done = "SELECT id, task_description, due_date FROM ccs_tasks WHERE status = 'done' ORDER BY created_at DESC";
        ...
        <script>
            ...
            function markNotificationsAsRead() {
                fetch('ccs-mark-notifications-read.php', {
                    method: 'POST',
                })
            ...
            function deleteNotification(notificationId) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch('ccs-delete-notification.php', {
                            method: 'POST',
                            headers: {
