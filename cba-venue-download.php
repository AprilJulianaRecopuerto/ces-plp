...
if (isset($_GET['id'])) {
    ...
    $reservationSql = "SELECT * FROM cba_reservation WHERE id = $id";
    ...
    $addedRequestSql = "SELECT reservation_id, additional_request, quantity FROM cba_addedrequest ORDER BY reservation_id DESC";
