        ...
        <div class="banner3">
            ...
            <div class="login-container">
                <form class="login-form" method="POST"  onsubmit="return validateEmail()">
					...
					<div class="links">
						<span class="default-style">Forgot <a href="college-forgot-password.php" class="highlight">password</a>?</span>
					</div>
                    ...
                    <div id="domainError" class="error-message" style="display: none;">
        ...
        <script>
            ...
            <?php if (isset($_SESSION['login_success']) && $_SESSION['login_success'] === true) : ?>
                ...
                confirmButtonText: 'Continue',
                    ...
                    const department = "<?php echo $_SESSION['redirect']; ?>";
                    let redirectUrl = 'default_dashboard.php'; // Default redirection
                    switch (department) {
                        ...
                        case 'College of Computer Studies':
                            redirectUrl = 'ccs-dash.php';
                            break;
                        case 'College of Education':
                            redirectUrl = 'coed-dash.php';
                            break;
                        case 'College of Engineering':
                            redirectUrl = 'coe-dash.php';
                            break;
                        case 'College of International Hospitality Management':
                            redirectUrl = 'cihm-dash.php';
                            break;
                        case 'College of Nursing':
                            redirectUrl = 'con-dash.php';
                            break;
                    }
                    window.location.href = redirectUrl;
                });

                <?php unset($_SESSION['login_success'], $_SESSION['redirect']); ?>
            <?php endif; ?>
