...
// Fetch budget details from the con_budget table
$budgetSql = "SELECT details_id, proj_title, lead_person, semester, expenses, remaining_budget, total_budget FROM con_budget ORDER BY details_id";
...
// Fetch the allotted budget for con (you can also dynamically change this for other departments)
$sql_allotted_budget = "SELECT allotted_budget FROM allotted_budget WHERE department_name = 'CON'";
...
// Fetch total expenses from the con_budget table
$sql_expenses = "SELECT SUM(expenses) AS total_expenses FROM con_budget";
    ...
    <body>
        ...
        <div class="content-budget">
            ...
            <div class="button-container">
                <button onclick="logAndRedirect('Add Budget', 'con-add-budget.php')">Add Budget</button>
            </div>

            <!-- New Budget Table -->
            <h2 style="font-family: Poppins, sans-serif;">CON Budget Details</h2>
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                        <?php
                        // Display budget data from con_budget table
