    ...
    <body>
        ...
        <div class="content-requi">
            <div class="button-container">
                    <button onclick="logAndRedirect('Add Requisition', 'coed-requi-list.php')">Requisition Form</button>
            </div>
                ...
                <div class="table-container">
                    <table class="crud-table">
                        ...
                        <tbody>
                            ...
                            $countSql = "SELECT COUNT(*) as total FROM coed_requisition";
                            $countResult = $conn->query($countSql);
                            $totalRecords = $countResult->fetch_assoc()['total'];
                            $totalPages = ceil($totalRecords / $limit); // Calculate total pages

                            // Fetch paginated requisition details
                            $requisitionSql = "SELECT * FROM coed_requisition ORDER BY requisition_id DESC LIMIT $limit OFFSET $offset";
                            ...
                            if ($resultRequisitions && $resultRequisitions->num_rows > 0) {
                                while ($row = $resultRequisitions->fetch_assoc()) {
                                    echo "<tr>
                                        ...
                                        <td class='edit'>
                                            <a href='coed-edit-requisition.php?requisition_id=" . $row["requisition_id"] . "'>EDIT</a>
                                            <button class='delete-button' data-id='" . $row["requisition_id"] . "'>DELETE</button>
                                            <a href='coed-requi-download.php?id=" . $row["requisition_id"] . "' class='download-button'>Download Report</a>
                                        </td>
                                    </tr>";
                                }
                            } else {
                ...
                <div class="table-container">
                    <table class="crud-table">
                        ...
                        <tbody>
                            ...
                            $itemsSql = "SELECT * FROM coed_items ORDER BY requisition_id DESC";
        ...
        <script>
            ...
            deleteButtons.forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    fetch(`coed-requi-delete.php?requisition_id=${requisitionId}`)
                ...
                function deleteRequisition(requisitionId, itemName) {
                    fetch(`coed-requi-delete.php?requisition_id=${requisitionId}&item_name=${itemName}`, {
                        method: 'POST'
                    })
                    .then(response => response.json())
                    .then(data => {
