    ...
    <body>
        ...
        <div class="content-requi">
                <div class="button-container">
                    <button onclick="window.location.href='coed-add-requi.php'">Requisition Form</button>
                </div>
                    ...
                    <div class="table-container">
                        <table class="crud-table">
                            ...
                            <tbody>
                                ...
                                $requisitionSql = "SELECT * FROM coed_requisition ORDER BY requisition_id LIMIT $limit OFFSET $offset";
                    ...
                    <div class="table-container">
                        <table class="crud-table">
                            ...
                            <tbody>
                                ...
                                $itemsSql = "SELECT * FROM coed_items ORDER BY requisition_id LIMIT $limit OFFSET $offset"; // Removed LIMIT and OFFSET for items
