...
if (isset($_GET['id'])) {
    ...
    $reservationSql = "SELECT * FROM coed_reservation WHERE id = $id";
    ...
    $addedRequestSql = "SELECT reservation_id, additional_request, quantity FROM coed_addedrequest ORDER BY reservation_id DESC";
