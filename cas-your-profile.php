...
<head>
    ...
    <body>
        ...
        <div class= "buttons">
            <a href="cas-edit-profile.php" class="edit-profile-button">Change Profile Picture</a>
            <a href="cas-change-password.php" class="change-password-button">Change Password</a>
        </div>
