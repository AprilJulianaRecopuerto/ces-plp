...
if (isset($_POST['delete_id'])) {
    ...
    $sql_fetch = "SELECT proj_title FROM cba WHERE id = ?";
    ...
    $stmt->close();
    header("Location: cba-projlist.php"); // Redirect back to project list page
    exit();
}
    ...
    <body>
        ...
        <div class="content-projectlist">
            <div class="button-container">
                <button onclick="logAndRedirect('Add Project', 'cba-addproj.php')">Add Project</button>
            </div>
            ...
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM cba ORDER BY id DESC LIMIT $limit OFFSET $offset";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>" . $row["status"] . "</td>
                                        <td class='edit'>
                                            <a href='cba-editproj.php?id=" . $row["id"] . "'>EDIT</a>
