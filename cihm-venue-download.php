...
if (isset($_GET['id'])) {
    ...
    $reservationSql = "SELECT * FROM cihm_reservation WHERE id = $id";
    ...
    $addedRequestSql = "SELECT reservation_id, additional_request, quantity FROM cihm_addedrequest ORDER BY reservation_id DESC";
