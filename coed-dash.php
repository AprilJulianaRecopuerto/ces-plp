...
$query = "SELECT COUNT(*) as count FROM coed_notifications WHERE coed_status = 'unread'";
...
$sql = "SELECT id, task_description, created_at, coed_status FROM coed_notifications ORDER BY created_at DESC";
    ...
    while ($row = $result_due_date->fetch_assoc()) {
        ...
        if (!in_array($taskId, $_SESSION['notified_tasks'])) {
            ...
            if (!empty($notificationMessage)) {
                ...
                $insertNotification = $conn->prepare("INSERT INTO coed_notifications (department, task_description, coed_status, created_at) VALUES (?, ?, 'unread', NOW())");
                $department = 'COED'; // Set department explicitly (or dynamically if needed)
...
<html lang="en">
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                <li><a href="coed-dash.php" class="active"><img src="images/home.png">Dashboard</a></li>
        ...
        <div class="content">
                    ...
                    <a href="coed-projlist.php">
                        ...
                        <div class="activities-details">
                            <div class="total-activities-count">
                                ...
                                $sql = "SELECT COUNT(*) as total FROM coed";
                                $result = $conn->query($sql);
            ...
            <div class="container">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['task_id'])) {
                    ...
                    $stmt = $conn->prepare("SELECT task_description FROM coed_tasks WHERE id = ?");
                    ...
                    $stmt = $conn->prepare("UPDATE coed_tasks SET status = 'done' WHERE id = ?");
                    $stmt->bind_param("i", $task_id);
                ...
                $sql = "SELECT id, task_description, due_date FROM coed_tasks WHERE status = 'pending' ORDER BY created_at DESC";
                $result = $conn->query($sql);
                ...
                $sql_done = "SELECT id, task_description, due_date FROM coed_tasks WHERE status = 'done' ORDER BY created_at DESC";
        ...
        <script>
            ...
            function markNotificationsAsRead() {
                fetch('coed-mark-notifications-read.php', {
                    method: 'POST',
                })
           ...
           // Function to delete a notification
            function deleteNotification(notificationId) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch('coed-delete-notification.php', {
                            method: 'POST',
                            headers: {
            ...
            document.addEventListener("DOMContentLoaded", () => {
                ...
                function fetchNotifications() {
                    ...
                    fetch(`coed-fetch_task.php?last_fetch_time=${encodeURIComponent(lastFetchTime)}`)
                        .then(response => response.json())
                        .then(data => {
                            const notificationCountElement = document.querySelector('.notification-count');
                            ...
                            if (data.notifications.length > 0) {
                                ...
                                notificationCountElement.textContent = data.notifications.filter(n => n.coed_status === 'unread').length;
                            } else {
