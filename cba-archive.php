...
$recycleBinDir = 'movuploads/cba-recycle/'; // Changed to cba-recycle
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['action'] === 'restore_image') {
        ...
        if (is_dir($itemPath)) {
            // Restoring a folder
            $restoreFolderPath = 'movuploads/cba-mov/' . $itemName; // Change to cba-mov
            ...
            if (!is_dir($restoreFolderPath)) {
                ...
                if (rename($itemPath, $restoreFolderPath)) {
                    ...
                    $sql = "INSERT INTO cba_mov (folder_name) VALUES ('$itemName')";
            ...
            $originalFolder = 'movuploads/cba-mov/' . $folderName; // Change to cba-mov
