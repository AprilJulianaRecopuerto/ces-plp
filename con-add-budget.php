...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="content-budget">
            ...
            <table class="crud-table">
                ...
                <tbody>
                    <?php
                    $projectsSqlModal = "SELECT id, proj_title, lead_person, semester, date_of_sub, dateof_imple FROM con ORDER BY id";
        ...
        <script>
            function addProjectToBudget(projectId) {
                ...
                xhr.open("POST", "con-add_to_budget.php", true);
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open("POST", "con-check_budget_limit.php", true);
            xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    if (response[0] === "error") {
                        ...
                        Swal.fire({
                            ...
                            xhrAdd.open("POST", "con-add_to_budget.php", true);
