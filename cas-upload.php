...
$uploadDir = 'movuploads/cas-mov/' . $folder_name . '/';
if (!is_dir($uploadDir)) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'delete_image') {
        ...
        $newImagePath = $recycleBinDir . basename($imagePath); // Move to the cas-recycle
    ...
    <head>
        ...
        <style>
            ...
            .image-item.highlighted {
                ...
                padding: 11px; /* This padding can help maintain consistent space */
            }
