...
// Fetch budget details from the cihm_budget table
$budgetSql = "SELECT details_id, proj_title, lead_person, semester, expenses, remaining_budget, total_budget FROM cihm_budget ORDER BY details_id";
...
// Fetch the allotted budget for CIHM (you can also dynamically change this for other departments)
$sql_allotted_budget = "SELECT allotted_budget FROM allotted_budget WHERE department_name = 'CIHM'";
...
// Fetch total expenses from the cihm_budget table
$sql_expenses = "SELECT SUM(expenses) AS total_expenses FROM cihm_budget";
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="cihm-budget-utilization.php" class="active"><img src="images/budget.png">Budget Allocation</a></li>
        ...
        <div class="content-budget">
            ...
            <div class="button-container">
                <button onclick="logAndRedirect('Add Budget', 'cihm-add-budget.php')">Add Budget</button>
            </div>

            <!-- New Budget Table -->
            <h2 style="font-family: Poppins, sans-serif;">CIHM Budget Details</h2>
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                        <?php
                        // Display budget data from cihm_budget table
