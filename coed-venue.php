    ...
    <nav class="navbar">
        ...
        <div class="content-venue">
            <div class="button-container">
                <button onclick="window.location.href='coed-add-venue.php'">Facilities Reservation Form</button>
            </div>
            ...
            <div class="data-details">
                ...
                <tbody>
                <?php
                    $requestSql = "SELECT * FROM coed_reservation ORDER BY id";
            ...
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                    <?php
                        $venueSql = "SELECT reservation_id, venue_name FROM coed_venue_request ORDER BY reservation_id";
            ...
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                    <?php
                        $additionalSql = "SELECT reservation_id, additional_request, quantity FROM coed_addedrequest ORDER BY reservation_id";
