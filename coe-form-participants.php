...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        // Fetch the link from evaluation_links where department = 'coe'
        $linkQuery = "SELECT response_link FROM evaluation_links WHERE department = 'COE'";
    ...
    <div class="banner1">
        ...
        <form id="signupForm" action="" method="POST">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 5px;">
                ...
                <input type="text" id="department" name="department" value="College of Engineering" readonly class="dept">
            </div>
...
// Fetch project titles from the coe table
$sql = "SELECT proj_title FROM coe";
