...
if (isset($_GET['id'])) {
    ...
    $reservationSql = "SELECT * FROM coe_reservation WHERE id = $id";
    ...
    $addedRequestSql = "SELECT reservation_id, additional_request, quantity FROM coe_addedrequest ORDER BY reservation_id DESC";
