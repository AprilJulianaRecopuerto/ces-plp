...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_file'])) {
    ...
    $archive_dir = 'movuploads/ccs-recycle'; // Directory to store deleted files
        ...
        <div class="content-task">
            <div class="header">
                ...
                <?php if ($subfolder_name): ?>
                    ...
                    <div class="back-button">
                        <a href="ccs-subfolder.php?folder=<?= urlencode($folder_name); ?>" class="back-link">
            ...
            <?php else: ?>
                ...
                <div class="folder-list">
                    ...
                    ?>
                        <a href="ccs-subfolder.php?folder=<?= urlencode($folder_name); ?>&subfolder=<?= $encoded_subfolder; ?>" class="folder-item">
