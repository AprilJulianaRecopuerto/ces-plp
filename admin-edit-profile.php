    ...
    if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] == 0) {
        ...
        if (in_array($imageFileType, $allowed_types)) {
            ...
            if (move_uploaded_file($file_tmp, $upload_dir . $new_file_name)) {
                ...
                $update_stmt = $conn->prepare("UPDATE users SET picture = ? WHERE username = ?");
...
if (isset($_POST['delete_picture'])) {
    ...
    $delete_stmt = $conn->prepare("UPDATE users SET picture = NULL WHERE username = ?");
            ...
            <?php if (isset($_SESSION['success'])): ?>
                Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = 'admin-your-profile.php';
                        }
                    });
            ...
            function confirmDeletion() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = 'admin-edit-profile.php';
