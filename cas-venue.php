...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO cas_reservation (date_of_request, name, college_name, event_activity, date_of_event, time_of_event, remarks) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        ...
        if (isset($_POST['venue_requests'])) {
            $venue_stmt = $conn->prepare("INSERT INTO cas_venue_request (reservation_id, venue_requests) VALUES (?, ?)");
            if (!$venue_stmt) {
                $_SESSION['error'] = "Preparation failed for venue request: " . $conn->error;
                header("Location: cas-venue.php"); // Redirect back to the form page
                exit;
            }
    ...
    <body>
        ...
        <div class="content-venue">
            ...
            <div class="data-details">
                ...
                <tbody>
                <?php
                  $requestSql = "SELECT * FROM cas_reservation ORDER BY id DESC";
            ...
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                    <?php
                       $additionalSql = "SELECT reservation_id, additional_request, quantity FROM cas_addedrequest ORDER BY reservation_id DESC";
           ...
           // Function to toggle the visibility of additional requests
            ...
            function showSuccessAlert() {
                Swal.fire({
                    ...
                    window.location.href = "cas-resource.php"; // Redirect to the dashboard or desired page
                });
            }
            ...
            deleteButtons.forEach(button => {
                button.addEventListener("click", function (event) {
                    ...
                    fetch(`cas-venue-delete.php?reservation_id=${reservationId}`)
