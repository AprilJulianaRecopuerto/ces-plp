...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_notification'])) {
    ...
    $sql = "DELETE FROM cas_notifications WHERE id = ?";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                <li><a href="cas-dash.php" class="active"><img src="images/home.png">Dashboard</a></li>
        ...
        <div class="content">
                    ...
                    <a href="cas-projlist.php">
                        ...
                        <div class="activities-details">
                            <div class="total-activities-count">
                                ...
                                $sql = "SELECT COUNT(*) as total FROM cas";
                                $result = $conn->query($sql);
            ...
            <?php
                ...
                $url = "http://localhost:5000/get_recommended_events/College%20of%20Arts%20and%20Sciences";
        ...
        <script>
            ...
            function markNotificationsAsRead() {
                fetch('cas-mark-notifications-read.php', {
                    method: 'POST',
                })
           ...
           // Function to delete a notification
            function deleteNotification(notificationId) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch('cas-delete-notification.php', {
                            method: 'POST',
                            headers: {
            ...
            document.addEventListener("DOMContentLoaded", () => {
                ...
                function fetchNotifications() {
                    ...
                    fetch(`cas-fetch_task.php?last_fetch_time=${encodeURIComponent(lastFetchTime)}`)
                        .then(response => response.json())
                        .then(data => {
                            const notificationCountElement = document.querySelector('.notification-count');
                            ...
                            if (data.notifications.length > 0) {
                                ...
                                notificationCountElement.textContent = data.notifications.filter(n => n.cas_status === 'unread').length;
                            } else {
