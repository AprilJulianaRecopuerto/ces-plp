...
if (isset($_GET['id'])) {
    ...
    $reservationSql = "SELECT * FROM con_reservation WHERE id = $id";
    ...
    $addedRequestSql = "SELECT reservation_id, additional_request, quantity FROM con_addedrequest ORDER BY reservation_id DESC";
