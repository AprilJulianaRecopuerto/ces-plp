...
// Fetch budget details from the coe_budget table
$budgetSql = "SELECT details_id, proj_title, lead_person, semester, expenses, remaining_budget, total_budget FROM coe_budget ORDER BY details_id";
...
// Fetch the allotted budget for coe (you can also dynamically change this for other departments)
$sql_allotted_budget = "SELECT allotted_budget FROM allotted_budget WHERE department_name = 'COE'";
...
// Fetch total expenses from the coe_budget table
$sql_expenses = "SELECT SUM(expenses) AS total_expenses FROM coe_budget";
    ...
    <body>
        ...
        <div class="content-budget">
            ...
            <div class="button-container">
                <button onclick="logAndRedirect('Add Budget', 'coe-add-budget.php')">Add Budget</button>
            </div>

            <!-- New Budget Table -->
            <h2 style="font-family: Poppins, sans-serif;">COE Budget Details</h2>
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                        <?php
                        // Display budget data from coe_budget table
