...
$recycleBinDir = 'movuploads/ccs-recycle/'; // Changed to ccs-recycle
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['action'] === 'restore_image') {
        ...
        if (is_dir($itemPath)) {
            // Restoring a folder
            $restoreFolderPath = 'movuploads/ccs-mov/' . $itemName; // Change to ccs-mov
            ...
            if (!is_dir($restoreFolderPath)) {
                ...
                if (rename($itemPath, $restoreFolderPath)) {
                    ...
                    $sql = "INSERT INTO ccs_mov (folder_name) VALUES ('$itemName')";
            ...
            $originalFolder = 'movuploads/ccs-mov/' . $folderName; // Change to ccs-mov
