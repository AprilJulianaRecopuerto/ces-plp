...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkSql = "SELECT details_id FROM ccs_budget WHERE proj_title = ?";
    ...
    if ($stmtCheck->num_rows > 0) {
        ...
        // Fetch the allotted budget for ccs
        $allottedBudgetSql = "SELECT allotted_budget FROM allotted_budget WHERE department_name = 'CCS'";
        ...
        $insertSql = "INSERT INTO ccs_budget (proj_title, lead_person, semester, expenses) VALUES (?, ?, ?, ?)";
