...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-projectlist">
            <h2>
                <span style="color: orange; font-size: 28px;"><?php echo htmlspecialchars($departmentName); ?></span> Projects
            </h2>

            <div class="button-container">
                <button onclick="window.location.href='coe-addproj.php'">Add Project</button>
            </div>
            ...
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM coe LIMIT $limit OFFSET $offset";
