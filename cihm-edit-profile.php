...
if ($result->num_rows > 0) {
    ...
    header("Location: cihm-edit-profile.php");
    exit;
}
    ...
    <body>
        ...
        <div class="content-editor">
            <div class="form-container">
                ...
                <form action="cihm-edit-profile.php" method="POST" enctype="multipart/form-data">
            ...
            <?php if (isset($_SESSION['success'])): ?>
                Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = 'cihm-your-profile.php';
                        }
                    });
            ...
            function confirmDeletion() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = 'cihm-edit-profile.php';
