    ...
    <body>
        ...
        <div class="content">
            <div class="chat-window" id="chatWindow">
                <?php foreach ($chatMessages as $chatMessage): ?>
                    <div class="message <?php echo ($chatMessage['message_type'] == 'user') ? 'user' : 'other'; ?>" 
                        ...
                        <form method="POST" action="con-chat.php" style="display:inline;" id="deleteForm_<?php echo $chatMessage['id']; ?>">
            ...
            <div class="message-input">
                <form method="POST" action="con-chat.php" style="width: 100%;" id="chat-form">
        ...
        <script>
           ...
           // Auto-scroll to the bottom of the chat window when the page loads or chat updates
                    ...
                    .then(data => {
                        ...
                        data.forEach(chatMessage => {
                            ...
                            if (chatMessage.sender === '<?php echo $_SESSION['uname']; ?>') {
                                ...
                                deleteForm.action = 'con-chat.php';
            ...
            document.addEventListener("DOMContentLoaded", () => {
                fetch('con-reset_notifications.php')
                    .then(response => response.json())
                    .then(data => {
