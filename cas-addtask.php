...
$db_user = "root";
$db_pass = "";
$dbname_user_registration = "user_registration"; // Correctly defined database name
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Database connection for task management
    ...
    $sql = "INSERT INTO cas (project_name, department, due_date, letter_request, act_plan, termof_ref, requi_form, venue_reserve, budget_plan) 
    ...
    if ($conn_task->query($sql) === TRUE) {
        ...
        // Insert notification into the 'mov' database
        ...
        if ($conn_mov->query($notification_sql) === TRUE) {
            ...
            $conn_users = new mysqli($db_host, $db_user, $db_pass, $dbname_user_registration);
        ...
        <script>
            ...
            <?php if (isset($_SESSION['success'])): ?>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'cas-task.php';
                    }
                });
            ...
            <?php if (isset($_SESSION['error'])): ?>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'cas-addtask.php';
                    }
                });
