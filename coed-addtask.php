...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_FILES[$file]) && $_FILES[$file]["error"] == 0) {
            ...
            if (in_array($file_type, $allowed_types)) {
                if (move_uploaded_file($_FILES[$file]["tmp_name"], $file_full_path)) {
                    ...
                    header("Location: coed-addtask.php");
                    exit;
                }
            } else {
    ...
    $sql = "INSERT INTO coed (project_name, department, due_date, letter_request, act_plan, termof_ref, requi_form, venue_reserve, budget_plan) 
        ...
        <script>
            ...
            <?php if (isset($_SESSION['success'])): ?>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'coed-task.php';
                    }
                });
            ...
            <?php if (isset($_SESSION['error'])): ?>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'coed-addtask.php';
                    }
                });
