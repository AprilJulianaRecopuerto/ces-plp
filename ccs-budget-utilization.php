...
// Fetch budget details from the ccs_budget table
$budgetSql = "SELECT details_id, proj_title, lead_person, semester, expenses, remaining_budget, total_budget FROM ccs_budget ORDER BY details_id";
...
// Fetch total expenses from the ccs_budget table
$sql_expenses = "SELECT SUM(expenses) AS total_expenses FROM ccs_budget";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-budget">
            ...
            <!-- New Budget Table -->
            <h2 style="font-family: Poppins, sans-serif;">CCS Budget Details</h2>
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                        <?php
                        // Display budget data from ccs_budget table
