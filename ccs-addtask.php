...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO ccs (project_name, department, due_date, letter_request, act_plan, termof_ref, requi_form, venue_reserve, budget_plan) 
        ...
        <script>
            ...
            <?php if (isset($_SESSION['success'])): ?>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'ccs-task.php';
                    }
                });
            ...
            <?php if (isset($_SESSION['error'])): ?>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'ccs-addtask.php';
                    }
                });
