...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkSql = "SELECT details_id FROM coed_budget WHERE proj_title = ?";
    ...
    if ($stmtCheck->num_rows > 0) {
        ...
        // Fetch the allotted budget for coed
        $allottedBudgetSql = "SELECT allotted_budget FROM allotted_budget WHERE department_name = 'coed'";
        ...
        $insertSql = "INSERT INTO coed_budget (proj_title, lead_person, semester, expenses) VALUES (?, ?, ?, ?)";
