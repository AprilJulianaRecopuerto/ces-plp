...
if (isset($_GET['month']) && isset($_GET['year'])) {
    ...
    $tables = ['cas', 'cba', 'ccs','coed', 'coe', 'cihm', 'con'];
...
if (isset($_GET['date'])) {
    ...
    $tables = ['cas', 'ccs', 'cba']; // List of tables to query
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="admin-calendar.php" class="active"><img src="images/calendar.png">Event Calendar</a></li>
