...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['response_form_link'])) {
    ...
    $sql = "UPDATE evaluation_links SET response_link = ? WHERE department = 'CON'";
    $stmt = $conn->prepare($sql);
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="con-responses.php" class="active"><img src="images/feedback.png">Responses</a></li>
    ...
    <div class="content">
        ...
        <div class="form-container">
            <form id="updateLinkForm" method="POST" action="">
                <label for="responseLink">con Response Form Link:</label>
                <?php
                // Fetch the current response link for the con department
                $fetchLinkSql = "SELECT response_link FROM evaluation_links WHERE department = 'CON'";
