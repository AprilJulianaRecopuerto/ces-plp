...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO cba_requisition (requi_sub, date, name, position, college_name) VALUES (?, ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        ...
        $itemStmt = $conn->prepare("INSERT INTO cba_items (requisition_id, item_name, total_items, total_usage) VALUES (?, ?, ?, ?)");
