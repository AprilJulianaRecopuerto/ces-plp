...
if (isset($_GET['requisition_id'])) {
    ...
    $sql = "SELECT * FROM coe_requisition WHERE requisition_id = $requisitionId";
    ...
    $itemsSql = "SELECT * FROM coe_items WHERE requisition_id = $requisitionId";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_GET['requisition_id'])) {
        ...
        $updateRequisitionSql = "UPDATE coe_requisition SET 
            date='$date',
            name='$name',
            position='$position',
        ...
        if ($conn->query($updateRequisitionSql) === TRUE) {
            ...
            $deleteItemsSql = "DELETE FROM coe_items WHERE requisition_id = $requisitionId";
            ...
            foreach ($items as $index => $itemName) {
                if (!empty($itemName)) { // Ensure the item name is not empty
                    ...
                    $insertItemsSql = "INSERT INTO coe_items (requisition_id, item_name, total_items, total_usage) 
        ...
        <script>
            ...
            function showSuccessAlert(message) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "coe-requi.php"; // Redirect to the same page or desired page
                    }
                });
            }
