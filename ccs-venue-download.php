...
if (isset($_GET['id'])) {
    ...
    $reservationSql = "SELECT * FROM ccs_reservation WHERE id = $id";
    ...
    $addedRequestSql = "SELECT reservation_id, additional_request, quantity FROM ccs_addedrequest ORDER BY reservation_id DESC";
