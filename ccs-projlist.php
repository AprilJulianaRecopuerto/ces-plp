...
if (isset($_POST['delete_id'])) {
    ...
    $sql_fetch = "SELECT proj_title FROM ccs WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        if ($result->num_rows > 0) {
            ...
            try {
                ...
                header("Location: ccs-projlist.php");
                exit;
            }
        } else {
    ...
    $stmt->close();
    header("Location: ccs-projlist.php"); // Redirect back to project list page
    exit();
}
    ...
    <body>
        ...
        <div class="content-projectlist">
            <div class="button-container">
                <button onclick="logAndRedirect('Add Project', 'ccs-addproj.php')">Add Project</button>
            </div>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>" . $row["status"] . "</td>
                                        <td class='edit'>
                                            <a href='ccs-editproj.php?id=" . $row["id"] . "'>EDIT</a>
