...
if ($result->num_rows > 0) {
    ...
    header("Location: cihm-change-password.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['current_password'], $_POST['new_password'], $_POST['confirm_password'])) {
    ...
    if ($new_password !== $confirm_password) {
        ...
        $username = $_SESSION['uname']; // Assuming username is stored in session
        $password_query = "SELECT password FROM colleges WHERE uname = ?";
        ...
        if ($password_result->num_rows > 0) {
            ...
            if ($current_password === $db_password) {
                ...
                $update_sql = "UPDATE colleges SET password = ? WHERE uname = ?";
    ...
    <body>
        ...
        <div class="content-editor">
            <div class="form-container">
                ...
                <form action="cihm-change-password.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <ul id="passwordCriteria">
                            ...
                            <li id="uppercaseCriteria" class="criteria">At least 1 uppercihme letter</li>
        ...
        <script>
            ...
            function checkPasswordStrength() {
                ...
                uppercaseCriteria.style.color = isUppercihmeValid ? 'green' : 'red';
