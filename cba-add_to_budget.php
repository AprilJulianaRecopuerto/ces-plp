...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkSql = "SELECT details_id FROM cba_budget WHERE proj_title = ?";
    ...
    if ($stmtCheck->num_rows > 0) {
        ...
        $allottedBudgetSql = "SELECT allotted_budget FROM allotted_budget WHERE department_name = 'CBA'";
        ...
        $insertSql = "INSERT INTO cba_budget (proj_title, lead_person, semester, expenses) VALUES (?, ?, ?, ?)";
