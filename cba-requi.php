    ...
    <body>
        ...
        <div class="content-requi">
            <div class="button-container">
                    <button onclick="logAndRedirect('Add Requisition', 'cba-requi-list.php')">Requisition Form</button>
            </div>
                ...
                <div class="table-container">
                    <table class="crud-table">
                        ...
                        <tbody>
                            ...
                            $countSql = "SELECT COUNT(*) as total FROM cba_requisition";
                            $countResult = $conn->query($countSql);
                            $totalRecords = $countResult->fetch_assoc()['total'];
                            $totalPages = ceil($totalRecords / $limit); // Calculate total pages

                            // Fetch paginated requisition details
                            $requisitionSql = "SELECT * FROM cba_requisition ORDER BY requisition_id DESC LIMIT $limit OFFSET $offset";
                            ...
                            if ($resultRequisitions && $resultRequisitions->num_rows > 0) {
                                while ($row = $resultRequisitions->fetch_assoc()) {
                                    echo "<tr>
                                        ...
                                        <td class='edit'>
                                            <a href='cba-edit-requisition.php?requisition_id=" . $row["requisition_id"] . "'>EDIT</a>
                                            <button class='delete-button' data-id='" . $row["requisition_id"] . "'>DELETE</button>
                                            <a href='cba-requi-download.php?id=" . $row["requisition_id"] . "' class='download-button'>Download Report</a>
                                        </td>
                                    </tr>";
                                }
                            } else {
                ...
                <div class="table-container">
                    <table class="crud-table">
                        ...
                        <tbody>
                            ...
                            $itemsSql = "SELECT * FROM cba_items ORDER BY requisition_id DESC";
        ...
        <script>
            ...
            deleteButtons.forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    fetch(`cba-requi-delete.php?requisition_id=${requisitionId}`)
                ...
                function deleteRequisition(requisitionId, itemName) {
                    fetch(`cba-requi-delete.php?requisition_id=${requisitionId}&item_name=${itemName}`, {
                        method: 'POST'
                    })
                    .then(response => response.json())
                    .then(data => {
