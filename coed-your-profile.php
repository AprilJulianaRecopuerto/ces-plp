...
<head>
    ...
    <body>
        ...
        <div class= "buttons">
            <a href="coed-edit-profile.php" class="edit-profile-button">Change Profile Picture</a>
            <a href="coed-change-password.php" class="change-password-button">Change Password</a>
        </div>
