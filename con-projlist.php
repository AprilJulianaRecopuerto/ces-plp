...
if (isset($_POST['delete_id'])) {
    ...
    $sql_fetch = "SELECT proj_title FROM con WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        if ($result->num_rows > 0) {
            ...
            try {
                ...
                header("Location: con-projlist.php");
                exit;
            }
        } else {
    ...
    $stmt->close();
    header("Location: con-projlist.php"); // Redirect back to project list page
    exit();
}
    ...
    <body>
        ...
        <div class="content-projectlist">
            <div class="button-container">
                <button onclick="logAndRedirect('Add Project', 'con-addproj.php')">Add Project</button>
            </div>
            ...
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM con ORDER BY id DESC LIMIT $limit OFFSET $offset";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>" . $row["status"] . "</td>
                                        <td class='edit'>
                                            <a href='con-editproj.php?id=" . $row["id"] . "'>EDIT</a>
