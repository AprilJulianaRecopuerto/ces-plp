...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-projectlist">
            <h2>
                <span style="color: pink; font-size: 28px;"><?php echo htmlspecialchars($departmentName); ?></span> Projects
            </h2>

            <div class="button-container">
                <button onclick="window.location.href='con-addproj.php'">Add Project</button>
            </div>
            ...
            <div class="table-container">
                <table class="crud-table">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM con LIMIT $limit OFFSET $offset";
