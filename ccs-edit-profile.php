...
if ($result->num_rows > 0) {
    ...
    header("Location: ccs-edit-profile.php");
    exit;
}
    ...
    <body>
        ...
        <div class="content-editor">
            <div class="form-container">
                ...
                <form action="ccs-edit-profile.php" method="POST" enctype="multipart/form-data">
            ...
            <?php if (isset($_SESSION['success'])): ?>
                Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = 'ccs-your-profile.php';
                        }
                    });
            ...
            function confirmDeletion() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = 'ccs-edit-profile.php';
